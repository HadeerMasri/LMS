...
<html lang="en">
	...
	<head>
		...
		<link href="{{asset('assets/admin/css/themes/layout/brand/dark.')}}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<script src="{{asset('assets/admin/js/pages/custom/login/login-general.j')}}s"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>
