  ...
  <!-- Create new item Modal -->
   <div class="modal fade" id="newModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
     <div class="modal-dialog">
       ...
       <form method="POST" action="{{ route('website-menu.store') }}" class="form-horizontal" role="form">
      @csrf
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
            <label for="title_en" class="col-lg-2 control-label">{{ __('admin/menu.fileds.title') }} ({{__('config.english')}})</label>
                <div class="col-lg-12">
       ...
       <div class="modal-content">
        <form action="" method="POST"  class="form-horizontal" role="form" id="edit-modal">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
                <label for="label" class="col-lg-2 control-label">{{ __('admin/menu.fileds.title') }} ({{__('config.english')}})</label>
                <div class="col-lg-12">
                  <input type="text" class='form-control' value="" name="title_en" id='patch_title_en' />
...
@push('style')
  <link href="{{ asset('admin/lib/nestable/nestable.css') }}" rel="stylesheet">
@endpush
@push('script')
...
$(function() {
  $('.dd').nestable({
    dropCallback: function(details) {
       ...
       $.post('{{ route("website-menu.store.item") }}',
	...
	$('.update-record').click(function() {
		var url = $(this).attr('data-url_website');
		$("#edit-modal").attr("action",url);
		$("#patch_title").val($(this).data('title'));
		$("#patch_title_en").val($(this).data('title_en'));
